  ...
  return (
    ...
    >
      ...
      <div className="about-text text--colors_secondary mt-8 text-[14px] sm:text-[14px] leading-[22px]">
        ...
        <p>
          Below, <i className="underline">are some key technologies</i> that I haved worked with:
        </p>
        ...
        <p className="mb-8">
          ...
          platform. It powers e-commerce experiences but with cryptocurrency based payments. Despite
          being the only member of my solo team, I was able to deliver both as the front-end
          developer, and also the smart-contract(blockchain) developer - within only a number of
          days. You can{' '}
          <a href="https://github.com/Okpainmo/deeco" className="underline text--colors_primary">
            learn more about deeco by clicking here
          </a>
          . You can also{' '}
          <a
            href="https://www.polygon.technology/blog/announcing-the-hackathon-winners-of-polygon-bootcamp-africa"
        ...
        <p className="mb-8">
          ...
          . I won accolades in two out of the three available winning categories. One of which was
          me being mentioned among the "top 10 noteworthy authors on Hashnode". You can{' '}
          <a
            href="https://townhall.hashnode.com/4articles4weeks-writeathon-the-winners"
            className="text--colors_primary underline"
            target="_blank"
            rel="noreferrer"
          >
            read the winners announcement article here
          </a>
          .
        </p>
        <p className="mb-8">
